...
ALLOWED_VIOLATIONS: frozenset[str] = frozenset(
    {
        "backend/app/integrations/assistant_client.py:22 -> backend.app.repositories.image_files",
        "backend/app/integrations/nodeimage/client.py:17 -> backend.app.repositories.image_files",
        "backend/app/integrations/r2/client.py:18 -> backend.app.repositories.image_files",
        "backend/app/integrations/r2/config.py:14 -> backend.app.repositories.image_files",
        "backend/app/integrations/r2/sync.py:18 -> backend.app.repositories.image_files",
