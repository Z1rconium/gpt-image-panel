...
ALLOWED_DEFERRED_IMPORTS: frozenset[str] = frozenset(
    {
        ...
        "backend/app/repositories/db/__init__.py:2020 -> backend.app.core.overall_config",
        "backend/app/repositories/db/__init__.py:2088 -> backend.app.core.overall_config",
