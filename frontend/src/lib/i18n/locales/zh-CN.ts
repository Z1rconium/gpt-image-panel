...
const zh: Translation = {
  ...
  maskEditor: {
    ...
    smoothHint: '平滑选区边缘；预览、覆盖率与导出使用同一规则',
    snap: '吸附',
    snapHint: '把套索与矩形的路径点吸附到最近的图像边缘',
    ...
    shortcuts: 'B/E/R/O/L/H 切换工具 · [ ] 调整笔刷 · S 边缘吸附 · 空格或中键拖动平移 · 滚轮缩放 · Alt 临时反选 · 0 适应画布 · Esc 取消当前拖动 · Ctrl/⌘+Z 撤销 · Ctrl/⌘+Shift+Z 或 Ctrl/⌘+Y 重做',
