const en = {
  ...
  messages: {
    ...
    editRetryMaskMissing: 'The saved mask could not be loaded. Re-edit the selection before retrying.',
    ...
    editRetryMaskMismatch: 'The current image could not be verified as the original edit source. Re-edit the selection before retrying.',
