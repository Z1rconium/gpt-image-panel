const en = {
  ...
  maskEditor: {
    ...
    shortcuts: 'B/E/R/L/H tools · [ ] brush size · Space or middle-drag pan · wheel zoom · Alt inverts add/subtract · 0 fit canvas · Ctrl/⌘+Z undo · Ctrl/⌘+Shift+Z or Ctrl/⌘+Y redo',
