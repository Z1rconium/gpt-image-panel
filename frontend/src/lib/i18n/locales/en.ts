const en = {
  ...
  maskEditor: {
    ...
    rect: 'Rectangle',
    lasso: 'Lasso',
    shapeHint: 'Drag to fill; hold Alt to erase',
    brushSize: (px: number) => `Brush ${px}px`,
    feather: (px: number) => `Feather ${px}px`,
    featherHint: 'Smooths the mask edge before export',
    undo: 'Undo',
    redo: 'Redo',
    invert: 'Invert',
    clear: 'Clear',
    ...
    keyboardHint: 'B/E tools · [ ] brush size · Space+drag pan · 0 reset · Ctrl/⌘+Z undo',
