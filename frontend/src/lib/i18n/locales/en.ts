const en = {
  ...
  maskEditor: {
    ...
    smoothHint: 'Smooths the selection edge; preview, coverage and export share one rule',
    snap: 'Snap',
    snapHint: 'Pulls lasso and rectangle points onto the nearest image edge',
    snapRadius: (px: number) => `Snap ${px}px`,
    snapGroupLabel: 'Edge snapping',
    undo: 'Undo',
    redo: 'Redo',
    invert: 'Invert',
    clear: 'Clear',
    ...
    shortcuts: 'B/E/R/O/L/H tools · [ ] brush size · S edge snap · Space or middle-drag pan · wheel zoom · Alt inverts add/subtract · 0 fit canvas · Esc cancels a drag · Ctrl/⌘+Z undo · Ctrl/⌘+Shift+Z or Ctrl/⌘+Y redo',
